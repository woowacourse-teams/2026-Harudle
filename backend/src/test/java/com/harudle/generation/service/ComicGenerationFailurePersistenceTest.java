...
@SpringBootTest
class ComicGenerationFailurePersistenceTest {
    ...
    void failGenerationAndDiscardDiaryAtomically() {
        ...
        ComicGeneration generation = comicGenerationRepository.saveAndFlush(ComicGeneration.start(
                diary.getId(),
        ...
        assertThat(comicGenerationRepository.findById(generation.getId()))
